...
from combust.models import VoxelCart1, VoxelCart2
from combust.train import Trainer

from shutil import copyfile
copyfile('../build.py', 'build.py')
...
n_channels = len(settings['model']['atom_types']) * len(settings['model']['grid_length'])

model = VoxelCart2(model_type=settings['model']['mode'],
                   voxel_valtype='norm',
                   ...
                   grad_total_energy=settings['model']['grad_total_energy'],
                   create_graph=True,
                   architecture=4,
                   out_channels=0,
                   cutoff_net='poly')
